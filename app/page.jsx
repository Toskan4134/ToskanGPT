...
export default function Chat() {
    ...
    return (
        <main className="flex text-text-primary">
            ...
            <SideMenu onChatChange={handleChatChange} selectedChatId={chatId} onSetPopupProps={setPopupProps} />
            <div className={`flex flex-col h-screen w-full bg-main-surface-primary left-0`}>
